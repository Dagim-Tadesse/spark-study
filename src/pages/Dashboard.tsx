...
const Dashboard = () => {
  ...
  const stats = [
    ...
    },
    {
      ...
      value: `${profile?.total_reviews ? Math.round((profile.successful_reviews / profile.total_reviews) * 100) : 0}%`,
      icon: Target,
  ...
  const dailyGoal = 20;
  const todayReviews = events.filter((e) =>
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-xl font-black">
                    {todayReviews} / {dailyGoal} {t("library.cards")}
                  </p>
                </div>
              </div>
              ...
              <p className="text-xs mt-4 opacity-90">
                {todayReviews >= dailyGoal
                  ...
                  : `Review ${dailyGoal - todayReviews} more cards to hit your daily goal.`}
              </p>
            </motion.div>
